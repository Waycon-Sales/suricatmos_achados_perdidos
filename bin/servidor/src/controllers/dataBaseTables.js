...
async createTables(){
    ...
    dbOpen.openDb().then(db=>{
        db.exec('CREATE TABLE IF NOT EXISTS objetos (id INTEGER PRIMARY KEY AUTOINCREMENT, titulo TEXT NOT NULL, local TEXT NULL, categoria TEXT NOT NULL, desc TEXT NULL, codObjeto TEXT NOT NULL, status TEXT NOT NULL, sinalizacao TEXT NULL, tipo TEXT NOT NULL, imgLink TEXT NULL, nome TEXT NULL, email TEXT NULL)');
